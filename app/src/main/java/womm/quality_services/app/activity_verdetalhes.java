...
public class activity_verdetalhes extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tvVDRDistanciaResult                =    findViewById(R.id.tvVDRDistanciaResult);
        ...
        //  CardView's  //
        CardView cvVDRAvaliar               =    findViewById(R.id.cvVDRAvaliar);
        ...
        cvVDRAvaliar.setOnClickListener((View.OnClickListener) this);
        ...
        distanciaF2 = bundle.getString("distanciaF2");
        ...
        String url ="https://dkvox.ngrok.io/qservices/detalhes.php?token=5Ywp8rCXwv7p0dWhis09GohiLetnpJuJ&nomehospital="+nometosearch;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                try
                {
                    ...
                    //SET Tempo de Espera
                    if (jObject.getString("tempoespera").equals("NA"))
                    {
                        tvVDRTempoesperaResult.setText("Nenhuma avaliação registrada.");
                        tvVDRTempoesperaResult.setTextColor(Color.parseColor("#737373"));
                    }
                    else
                        {
                    ...
                    //SET Nota Geral
                    if (jObject.getString("notageral").equals("NA"))
                    {
                        tvVDRNotageralResult.setText("Nenhuma avaliação registrada.");
                        tvVDRNotageralResult.setTextColor(Color.parseColor("#737373"));
                    }
                    else
                        {
        ...
        //SET Distancia
        tvVDRDistanciaResult.setText(distanciaF2);
        if (tvVDRDistanciaResult.getText().equals("Não Selecionado"))
        {
            //Log.d("TAG","distancia: Não Selecionado");
            tvVDRDistanciaResult.setText("Filtro não selecionado.");
            tvVDRDistanciaResult.setTextColor(Color.parseColor("#737373"));
        }
    ...
    public void onClick(View view)
    {
        switch (view.getId())
        {
            ...
            case R.id.cvVDRAvaliar :
                //  Log de onClick  //
                //Log.d("tag","onClick no cvVDRAvaliar");

                Intent intentVDRaAvaliar = new Intent(activity_verdetalhes.this, activity_avaliarvd.class);
                intentVDRaAvaliar.putExtra("hospitalSelecionado", hospitalF2);
                startActivity(intentVDRaAvaliar);
                break;
